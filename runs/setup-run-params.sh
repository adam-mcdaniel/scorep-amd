if [ -z $INSTALL_DIR ]; then
	...
	export VT_AROCM2_SMI_BUF_SIZE=128M
	export VT_CORETEMP_BUF_SIZE=128M
	export SCOREP_METRIC_AROCM_SMI_INTERVAL_US=1000
	export SCOREP_METRIC_AROCM_SMI_PLUGIN='rocm_smi:::gpu_clk_freq_System:device=0:current,rocm_smi:::gpu_clk_freq_System:device=2:current,rocm_smi:::gpu_clk_freq_System:device=4:current,rocm_smi:::gpu_clk_freq_System:device=6:current,rocm_smi:::temp_current:device=0:sensor=1,rocm_smi:::temp_current:device=2:sensor=1,rocm_smi:::temp_current:device=4:sensor=1,rocm_smi:::temp_current:device=6:sensor=1,rocm_smi:::energy_count:device=0,rocm_smi:::energy_count:device=2,rocm_smi:::energy_count:device=4,rocm_smi:::energy_count:device=6,rocm_smi:::power_average:device=0:sensor=0,rocm_smi:::power_average:device=2:sensor=0,rocm_smi:::power_average:device=4:sensor=0,rocm_smi:::power_average:device=6:sensor=0,rocm_smi:::memory_busy_percent:device=0,rocm_smi:::memory_busy_percent:device=2,rocm_smi:::memory_busy_percent:device=4,rocm_smi:::memory_busy_percent:device=6,rocm_smi:::busy_percent:device=0,rocm_smi:::busy_percent:device=2,rocm_smi:::busy_percent:device=4,rocm_smi:::busy_percent:device=6'
	# export SCOREP_METRIC_AROCM2_SMI_INTERVAL_US=1000
	# export SCOREP_METRIC_AROCM2_SMI_PLUGIN='rocm_smi:::memory_busy_percent:device=0'
	# Needs timestamps for cray metrics
	export SCOREP_METRIC_CORETEMP_INTERVAL_US=1000
	export SCOREP_METRIC_CORETEMP_PLUGIN='coretemp:::craypm:power,coretemp:::craypm:energy,coretemp:::craypm:freshness,coretemp:::craypm:cpu_energy,coretemp:::craypm:cpu_power,coretemp:::craypm:accel0_energy,coretemp:::craypm:accel0_power,coretemp:::craypm:accel1_energy,coretemp:::craypm:accel1_power,coretemp:::craypm:accel2_energy,coretemp:::craypm:accel2_power,coretemp:::craypm:accel3_energy,coretemp:::craypm:accel3_power'
