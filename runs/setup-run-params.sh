if [ -z $INSTALL_DIR ]; then
	...
	export SCOREP_METRIC_AROCM_SMI_PLUGIN='rocm_smi:::gpu_clk_freq_System:device=0:current,rocm_smi:::gpu_clk_freq_System:device=1:current,rocm_smi:::gpu_clk_freq_System:device=2:current,rocm_smi:::gpu_clk_freq_System:device=3:current,rocm_smi:::gpu_clk_freq_System:device=4:current,rocm_smi:::gpu_clk_freq_System:device=5:current,rocm_smi:::gpu_clk_freq_System:device=6:current,rocm_smi:::gpu_clk_freq_System:device=7:current,rocm_smi:::temp_current:device=0:sensor=0,rocm_smi:::temp_current:device=2:sensor=0,rocm_smi:::temp_current:device=4:sensor=0,rocm_smi:::temp_current:device=6:sensor=0,rocm_smi:::energy_count:device=0,rocm_smi:::energy_count:device=2,rocm_smi:::energy_count:device=4,rocm_smi:::energy_count:device=6'
